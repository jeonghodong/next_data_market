...
export default function Footer() {
  const [policy, setPoliy] = useState(false)
  ...
  return (
    <Box sx={BoxStyle}>
      <Container maxWidth="xl" sx={ContainerStyle}>
        ...
        <Button variant="contained" onClick={handleOpenPolicy} sx={{ py: "1rem", px: "1.5rem", borderRadius: "1rem" }}>개인정보취급방침</Button>
        <Dialog
          open={policy}
          onClose={handleClosePolicy}
        >
          <DialogTitle id="scroll-dialog-title">개인정보처리방침</DialogTitle>
          <DialogContent >
            <DialogContentText>
              &lt;아타드&gt; (이하 '회사')는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립․공개합니다.
              <br />
              <br />
              제1조(개인정보의 처리목적)
              ...
              홈페이지 회원 가입 및 관리
              <br />
              필수항목 : 성명, 아이디, 비밀번호, 주소, 전화번호, 이메일주소
              <br />
              선택항목 :
              <br />
              재화 또는 서비스 제공
              ...
              제13조(개인정보 처리방침 변경)
              <br />
              이 개인정보 처리방침은 2021. 00. 00부터 적용됩니다.
              <br />
              이전의 개인정보 처리방침은 공지사항에서 확인하실 수 있습니다.
            </DialogContentText>
          </DialogContent>
          <DialogActions>
            <Button onClick={handleClosePolicy}>닫기</Button>
          </DialogActions>
        </Dialog>
      </Container>
    </Box>
